...
// import sampleImage from '../assets/result.png'; 
...
function Guidelines() {
  return (
    <div className="guidelines-body"> {/* Scoped unique class for the body */}
      <div className="guidelines-header">
        <h1>Exam Guidelines</h1>
        <p className="thank-you-message">Thank you for registering! Please review the guidelines below before starting your exam.</p> {/* Thank-you message */}
      </div>
